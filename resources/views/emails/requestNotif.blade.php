...
<html>
    <body>
      ...
      <p>
        ...
        <span style="">{{date('H:i', strtotime($appointment->start_time))}} - {{date('H:i', strtotime($appointment->end_time))}}. Click <a href="http://appointment-scheduler.dev/#/scheduler/appointment/{{$appointment->id}}/details">here</a> to confirm attendance.</span>
      </p>
      <hr>
